...
class ChooseParentDirToMoveChildrenTo(defaultapp.DefaultApp):
    ...
    def handle_entry_activation(self):
        ...
        self._entries_model._bookmark_store.move_children_of_entry(self._entry_guid, dest_parent_guid)
